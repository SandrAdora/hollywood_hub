...
# Project Setup and Exceution Guide 
 ...
 # Load the Application: 
   ...
   ## Navigating through Application 
    ...
    1. Click on the actor's name to obtain detailed information 
    2. Alternatively, manually enter the actor's name into the search field
    3. If the name is misspelled, an error notification will be displayed
# Testing
